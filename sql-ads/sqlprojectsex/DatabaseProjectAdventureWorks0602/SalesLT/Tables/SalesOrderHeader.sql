...
ADD SENSITIVITY CLASSIFICATION TO
    ...
    WITH (LABEL = 'Confidential', LABEL_ID = '05e6eaa1-075a-4fb4-a732-a92215a2444a', INFORMATION_TYPE = 'Financial', INFORMATION_TYPE_ID = 'c44193e1-0e58-4b2a-9001-f7d6e7bc1373', RANK = MEDIUM);


GO
ADD SENSITIVITY CLASSIFICATION TO
    [SalesLT].[SalesOrderHeader].[CreditCardApprovalCode]
    WITH (LABEL = 'Confidential', LABEL_ID = '05e6eaa1-075a-4fb4-a732-a92215a2444a', INFORMATION_TYPE = 'Credit Card', INFORMATION_TYPE_ID = 'd22fa6e9-5ee4-3bde-4c2b-a409604c4646', RANK = MEDIUM);
